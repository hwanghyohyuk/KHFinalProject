			...
			<div id="carousel-event" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" style="height: 500px;">
					<c:forEach var="et3" items="${data.evetop3}" varStatus="status">
						...
						<span> <img
							src="/everycvs/resources/user/img/event/event_${status.index}.PNG"
							style="height: 500px;">
...
<div id="content" class="bottom-border-shadow">
	<div class="container background-white bottom-border">
		<div class="row margin-top-60 margin-bottom-30">
				...
				<div class="col-md-4 col-sm-4 col-xs-12 margin-bottom-30">
					<div id="carousel-popprd-1" class="carousel slide"
						...
						<div class="col-md-12 text-center margin-bottom-20"
							...
							<h2>
								<span><img alt=""
									src="/everycvs/resources/user/img/main/gs25-logo.gif"></span>
							</h2>
						</div>
						<!-- Indicators -->
						<ol class="carousel-indicators">
						...
						<div class="carousel-inner" role="listbox" style="height: 210px;">
							<c:forEach var="gt3" items="${data.gstop3}" varStatus="status">
								...
								<span><img alt="${gt3.product_name }"
									style="height: 210px;"
									src="/everycvs/resources/upload/${gt3.stored_file_name}"></span>
								<div class="carousel-caption"
									style="background-color: rgba(255, 255, 255, 0.5);">
			...
			<div class="col-md-4 col-sm-4 col-xs-12 margin-bottom-30">
				<div id="carousel-popprd-2" class="carousel slide"
					data-ride="carousel">
					<div class="col-md-12 text-center margin-bottom-20"
						style="height: 50px;">
						<h2>
							<span><img alt=""
								src="/everycvs/resources/user/img/main/cu-logo.gif"></span>
						</h2>
					</div>
					<!-- Indicators -->
					<ol class="carousel-indicators">
						<li data-target="#carousel-popprd-2" data-slide-to="0"
							class="active"></li>
					...
					<div class="carousel-inner" role="listbox" style="height: 210px;">
						<c:forEach var="ct3" items="${data.cutop3}" varStatus="status">
							...
							<span><img alt="${ct3.product_name }"
								style="height: 210px;"
								src="/everycvs/resources/upload/${ct3.stored_file_name}"></span>
							<div class="carousel-caption"
								style="background-color: rgba(255, 255, 255, 0.5);">
		...
		<div class="col-md-4 col-sm-4 col-xs-12 margin-bottom-30">
			<div id="carousel-popprd-3" class="carousel slide"
				data-ride="carousel">
				<div class="col-md-12 text-center margin-bottom-20"
					style="height: 50px;">
					<h2>
						<span><img alt=""
							src="/everycvs/resources/user/img/main/seven-logo.png"></span>
					</h2>
				</div>
				<!-- Indicators -->
				<ol class="carousel-indicators">
					<li data-target="#carousel-popprd-3" data-slide-to="0"
						class="active"></li>
				...
				<div class="carousel-inner" role="listbox" style="height: 210px;">
					<c:forEach var="st3" items="${data.svtop3}" varStatus="status">
						...
						<span><img alt="${st3.product_name }"
							style="height: 210px;"
							src="/everycvs/resources/upload/${st3.stored_file_name}"></span>
						<div class="carousel-caption"
							style="background-color: rgba(255, 255, 255, 0.5);">
			...
			<!-- Controls -->
			<a class="left carousel-control" href="#carousel-popprd-3"
				role="button" data-slide="prev"> <span
				class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
				<span class="sr-only">Previous</span>
			</a> <a class="right carousel-control" href="#carousel-popprd-3"
				role="button" data-slide="next"> <span
				class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
				<span class="sr-only">Next</span>
			</a>
...
<div id="content" class="bottom-border-shadow">
	<div class="container background-white bottom-border">
		<div class="row margin-vert-60">
				...
				<div class="col-md-6  col-sm-6 col-xs-12 margin-top-30">
					<div class="input-group">
						<span class="input-group-addon" id="basic-addon1">주소검색</span> <input
							...
							<button id="init" type="button" class="btn btn-default btn-lg"
								data-toggle="tooltip" data-placement="top" title="나의 위치">
			...
			<div class="margin-bottom-10" id="map" style='height: 500px'></div>
			<div>
				<div role="tabpanel">
					<ul class="nav nav-tabs" role="tablist" id="mapTab">
						<li role="presentation" class="active"><a href="#todays" onclick="selectAjax(1);"
							aria-controls="todays" role="tab" data-toggle="tab">오늘의 상품</a></li>
						<li role="presentation"><a href="#expiration" onclick="selectAjax(2);"
							aria-controls="expiration" role="tab" data-toggle="tab">유통기한 임박
								상품</a></li>
								<c:if test="${sessionScope.user eq null}">
						<li role="presentation"><a href="#favorite" onclick="needSign();"
							aria-controls="favorite" role="tab" data-toggle="tab">나의 관심
								상품</a></li>
								</c:if>
								<c:if test="${sessionScope.user ne null}">
						<li role="presentation"><a href="#favorite" onclick="selectAjax(3);"
							aria-controls="favorite" role="tab" data-toggle="tab">나의 관심
								상품</a></li>
								</c:if>
					</ul>
					<div class="tab-content" style="height:164px;padding-top:20px">
						<div role="tabpanel" class="tab-pane active" id="todays">
						<div id="viewLoading1"class="margin-vert-50 margin-horiz-50"><img src="/everycvs/resources/user/img/loading/350.gif" /></div>
						</div>
						<div role="tabpanel" class="tab-pane" id="expiration">
