...
SELECT GIFTICON_NO, BARCODE_IMG_NAME, STORE_NAME, PRODUCT_NAME FROM TB_GIFTICON
JOIN TB_PURCHASE USING (PURCHASE_NO)
JOIN TB_USER USING (USER_NO)
JOIN TB_STORE_PRODUCT USING (STORE_PRODUCT_NO)
JOIN TB_STORE ON (TB_STORE.STORE_NO = TB_STORE_PRODUCT.STORE_NO)
JOIN TB_PRODUCT ON (TB_PRODUCT.PRODUCT_NO = TB_STORE_PRODUCT.PRODUCT_NO);
