    ...
    <div class="container background-white">
        <div class="row margin-vert-30">
        	<div class="col-lg-10 col-lg-offset-1col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-12 col-xs-offset-0">
					...
					<form id="modifyform" action="/everycvs/user/modifypost.do" method="post">
					...
					<c:if test="${user.job eq 'storemanager'}">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="margin-bottom-40">
								...
								<textarea class="form-control" style="resize: none;font-size: 18px;line-height: 1.33;" placeholder="Information" rows="5" readonly id="storeinfo" name="sinfo">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div class=" input-group-lg  margin-bottom-40" id="emailstatus">
							...
							<input class="form-control" placeholder="Email" id="signupemail" name="email" type="email" value="${user.email}" readonly> 
						</div>
						...
						<div class="input-group-lg  margin-bottom-40 has-feedback" id="phonestatus">
							<label>Phone</label> 
							<input class="form-control" id="phone" name="phone" placeholder="01012341234" type="tel" oninput="phoneCheck();" value="${user.phone }">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div
							...
							<div class="input-group-lg  margin-bottom-40 has-feedback" id="addressstatus">
								<label>Address</label> 
								<input class="form-control" placeholder="Address" id="address" name="address" type="text" oninput="addressCheck();" value="${user.address }">
