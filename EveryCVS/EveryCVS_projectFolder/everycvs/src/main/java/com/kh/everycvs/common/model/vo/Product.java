...
public class Product implements Serializable {
	...
	public String toString() {
		return product_no + ", " + product_name + ", " + manufacturer + ", " + price + ", " + expiration_date + ", " + product_kind_no + ", " + 
			   product_kind_name + ", " + brand_no + ", " + original_file_name + ", " + stored_file_name + ", " + del_check + ", " + purchase_count;
	}
