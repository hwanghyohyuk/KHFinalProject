		...
		<div class="row margin-vert-30">
			...
			<div class="col-lg-10 col-lg-offset-1col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-12 col-xs-offset-0">
					...
					<div class="signup-header margin-bottom-40">
						...
						<input name="job" type="hidden" value="storemanager"> 
					</div>
					<hr>
					<div class="row">
					<!-- 페이지 상단부분 -->
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="input-group-lg  margin-bottom-40" id="numstatus">
								<label>Your Store Enroll Number</label>
								<span class="input-group input-group-lg ">
								<input class="form-control" placeholder="Store Enroll Number" type="text" id="enrollNo" name="eno" oninput="enrollNoCheck();"> 
							 	<span class="input-group-btn">
								<button type="button" class="btn btn-primary pull-right" onclick="enrollNoCompare();">Check Number</button>
								</span>
								</span>
							</div>
							...
							<div class="margin-bottom-40">
								...
								<textarea class="form-control" style="resize: none;font-size: 18px;line-height: 1.33;" placeholder="Information" rows="5" readonly id="storeinfo" name="sinfo"></textarea>
							</div>
							<hr>
						</div>
						<!-- 페이지 왼쪽부분 -->
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
								<button class="btn btn-primary btn-lg pull-right" type="button" onclick="adminSubmit();">Registration</button>
							</div>
						</div>
					</div>
					</form>
