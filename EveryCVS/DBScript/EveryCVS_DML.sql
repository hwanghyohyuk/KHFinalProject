...
*/
SELECT STORE_PRODUCT_NO, STORE_NO, PRODUCT_NO, PRODUCT_NAME, MANUFACTURER, PRICE, MANUFACTURE_DATE, 
A.MANUFACTURE_DATE+B.EXPIRATION_DATE-SYSDATE AS EXPIRATION_DAY, A.QUANTITY, B.PRODUCT_KIND_NO, B.BRAND_NO,
