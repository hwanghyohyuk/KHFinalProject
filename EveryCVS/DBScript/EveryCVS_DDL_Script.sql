...
CREATE TABLE TB_SERVICE_CENTER (
	...
	DEL_CHECK VARCHAR2(1) NOT NULL /* 삭제구분 */
);
...
CREATE TABLE TB_DC_INFO (
	DISCOUNT_NO VARCHAR2(30) NOT NULL, /* 할인번호 */
	DISCOUNT_NAME VARCHAR2(30) NOT NULL /* 할인명 */
);
...
CREATE TABLE TB_PRODUCT_KIND (
	...
	PRODUCT_KIND_NAME VARCHAR2(30) NOT NULL /* 상품종류명 */
);
...
CREATE TABLE TB_GIFTICON (
    ...
    BARCODE_IMG_NAME VARCHAR2(36), /* 바코드이미지이름*/
	IS_USE VARCHAR2(1) NOT NULL /* 사용여부 */
);
...
COMMENT ON COLUMN TB_GIFTICON.BARCODE_IMG_NAME IS '바코드이미지이름';
...
ALTER TABLE TB_PRODUCT
	ADD
		CONSTRAINT FK_TB_PR_KIND_TO_TB_PRODUCT
		FOREIGN KEY (
			PRODUCT_KIND_NO
		)
