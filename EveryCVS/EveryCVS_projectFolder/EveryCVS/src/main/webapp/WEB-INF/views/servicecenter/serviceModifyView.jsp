...
<script type="text/javascript">
	function serviceUpdate() {
		location.href = '/everycvs/page/serviceUpdate.do';
	}
	...
	<div class="container background-white">
		<div class="row margin-vert-30">
			...
			<div class="col-md-9">
				...
				<hr>
				<form name="servicecenter" method="post"
					action="/everycvs/page/serviceUpdate.do">
					<input type="hidden" name="writer"
						value="${sessionScope.user.user_no }"> <input
						type="hidden" name="service_no"
						value="${servicecenter.service_no }"> <label>작성자 <span
					...
					<div class="row margin-bottom-20">
						<div class="col-md-8 col-md-offset-0">
							<textarea id="contents" name="contents" rows="8"
								class="form-control" placeholder="내용을 입력해주세요">${servicecenter.contents }</textarea>
						</div>
					</div>
					<div align="center">
